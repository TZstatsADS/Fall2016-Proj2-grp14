  ...
  tabItems(
           tabItem(tabName = "SummarybyArea",
                   ...
                   tabsetPanel(id="SummaryTabSet",
                              ...
                              tabPanel("Time Series",value="TimeSeries",highchartOutput("TSPlot",width = "100%")),
                              ...
                              tabPanel("By Car",value="ByCar",plotlyOutput("ByCar",width = "100%")),
                              tabPanel("By Car 2",value="ByCar2",plotlyOutput("ByCar2",width = "100%"))
...
###Page2  Summary By Area
  ...
  output$Seasonality=renderHighchart({
    ...
    SeasonalData$year<-as.factor(substr(New.Sum.Data2$ForSeasonality$DATE1,4))
