...
body <- dashboardBody(
  tabItems(
    ...
    tabItem(tabName = "Average Collision count VS Year By Vehicle Type",
            plotOutput("ppplot8",width = "100%")
    ),
    tabItem(tabName = "Average Collision count VS Time By Vehicle Type",
            plotOutput("ppplot9",width = "100%")
    ),
    tabItem(tabName = "TBD",
...
server <- function(input, output,session) {
  ...
  ###Page 5 Collision count vs year by vehicle type
  ##// Yiwei
  year_start=2012
  year_end=2015
  time_start=10
