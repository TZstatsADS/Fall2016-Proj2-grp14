...
#collisionData=read.csv("collision_dateframe.csv")[1:5000,]
  ...
  tabItems(
           tabItem(tabName = "MapSetting",
                   ...
                   fluidRow(column(4,textInput("AddressInput","Find a Place:","Columbia University, NY"),
                                   ...
                                   hr(),
                                   sliderInput("Hour",label="Hours included in Summary",min=0,max=24,value=c(0,24))),
           ...
           tabItem(tabName = "SummaryByArea",
                   fluidRow(column(8,leafletOutput("Map2", width="100%",height=400)),
                   ...
                   tabsetPanel(id="SummaryTabSet",
                              tabPanel("Summary 1",textOutput("SummaryText")),
                              tabPanel("Summary 2",plotOutput("ppplot1",width = "100%")),
                              tabPanel("Summary 3",plotOutput("ppplot6",width = "100%")),
                              tabPanel("Summary 4",plotOutput("ppplot7",width = "100%")),
                              tabPanel("Summary 5",plotOutput("ppplot8",width = "100%")),
                              tabPanel("ViewCCTV",
                                      uiOutput("cctv")
                                      #textOutput("test1")
                                      )
...
###Page2  Summary By Area
  ...
  observe({
    if (!is.null(input$Map_bounds)){
      ...
      output$MonthSelected=renderText(paste(latRng,lngRng))
    }
  })
