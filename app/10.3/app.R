...
###Page 5 Read Me
  output$ppplot3=renderText(paste("This is an unstable version. This version is just to show the idea. Further development can be done if needed. Ff it goes wrong, don't click that tab next time run it.","
                            In the map, there are only 3000 points drawn, but in fact there are 740000 data entries in our analysis plots",sep="\n"))
